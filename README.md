...
and the [related projetcs](https://docs.cwepr.de/v0.5/) (see also [*FOSS
for Spectroscopy*](https://bryanhanson.github.io/FOSS4Spectroscopy/))
have been developed, so far. The `{eprscope}`, as the first complex
<img src="https://www.r-project.org/Rlogo.png" width="16" height="16" />
...
3.  Download and install [*RStudio
    ...
    <img src="https://www.r-project.org/Rlogo.png" width="16" height="16" />
    compatible environments, you may install it as well.
...
necessary for sharing all the results coming from `{eprscope}` in
desired formats like `pdf` , `html` , `docx` , `pptx` or `tex` (details
may be found in the `create_qmdReport_proj()` documentation).

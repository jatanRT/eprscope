...
As mentioned above, the data analysis workflow also covers the dissemination/sharing of result from analysis mostly by tables, figures, papers, thesis, presentations, webpages or even blogs. However, quite often in addition to essential processing of EPR spectra the spectral analysis (which usually corresponds to determination of hyperfine coupling/splitting constants and the *g*-factors) requires quantum chemical calculations, on the computational servers, and/or the above-mentioned simulations of EPR spectra done within the *MATLAB* by *EasySpin*[^3]*.* Therefore, one must combine the outputs/results in order to gather the entire structural information about the paramagnetic center. As can be seen on Figure \@ref(fig:scheme-intro) ...etc.

...
However, it is evident that the variance (and the standard deviation) of residuals is slightly higher along the fitted/predicted values in comparison to the original residuals/errors:

...
As already mentioned in `vignette("functionality")` the EPR spectra and the related data can be mostly visualized by several options using the... packages

...
In order to process data frames by other software tools, different from ![](RcoreLogo.png){width="16" height="12"} (e.g. in excel-like sheet format), they may be exported into universal `.csv` table format like by `base::write.csv()` function ➨

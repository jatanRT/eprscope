...
# two distances or HFSCs (a in mT) 
...
According to literature [@GramppGpda2005] and the $\ce{TMPD^{.+}}$ structure depicted above the interacting nuclei may be divided into three groups of equivalent nuclei: $2\,\times\,\ce{^{14}N}$, $4\,\times\,\ce{^1H}$ (aromatic protons) and $12\,\times\,\ce{^1H}$ (methyl protons).

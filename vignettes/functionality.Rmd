...
Maximal value of the double/sigmoid integral `r round(max(tmpd.data.norm.02.integCorr$sigmoid_Integ),digits = 3)` can be used for the estimation of $\ce{TMPD^{.+}}$ amount within the sample.

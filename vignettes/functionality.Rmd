...
# visualization of the first 10 rows by `{flextable}` 
# and pipe oerator "%>%" which is an expression of a sequence 
# of operations that transform an object

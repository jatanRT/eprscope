...
sim.tmpd.iso <- 
  eval_sim_EPR_iso(g.iso = tmpd.g.iso.spec,
                   ...
                   natur.abund = TRUE, # take into account the natural abundance of the nuclei above
                   lineGL.DeltaB = list(0.05,0.05), # Gaussian (G) and Lorentzian (L) linewidth in mT

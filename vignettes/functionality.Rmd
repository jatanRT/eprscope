...
4.  `.out`, `.log` ASCII text outputs returned either form [*Gaussian*](https://gaussian.com/gaussian16/) or [*Orca*](https://www.faccts.de/docs/orca/6.1/tutorials/spec/EPR.html) quantum chemical packages, containing the computed EPR parameters such as hyperfine coupling/splitting constants (*A*/*a*, see below) and g-values.

...
#'   corresponding to lower and upper \strong{visual limit} of the selected \eqn{B}-region,
...
#'   \item{cov.df}{Covariance \code{matrix} of a data frame, consisting of EPR experimental, simulated (best fit) and the residual

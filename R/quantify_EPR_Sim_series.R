...
#'   (see also the parameter/argument \code{var2nd.series}). Such data frame can be created, e.g.
#'   by the \code{\link{readEPR_Exp_Specs_kin}} or the \code{\link{readEPR_Exp_Specs_multif}} function.
#' @param dir_ASC_sim Character string, pointing to folder where the simulated EPR spectra (data files) of all
...
#'   corresponds to \code{floor(10+2*sqrt(length(optim.params.init)))} (e.g. for 3 spectral components
#'   \code{pswarm.size} = 14).

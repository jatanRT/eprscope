...
#'   of the \code{selected B region} (therefore abbreviation \code{.reg.})
#'
#' @return g-value according to \eqn{(\nu * h)/(\mu_B * B)}, where the \code{B} comes directly from
#'   the EPR spectrum and is actually calculated between the \code{B(maximum)} and \code{B(minumum)}
#'   (these do not equal to 'B.reg.start' and 'B.reg.min'!) corresponding to maximum and minimum
#'   of the derivative intensity (\code{dIepr_over_dB})
#'
#' @examples
#' \dontrun{

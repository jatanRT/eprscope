...
#'
#' \deqn{\nu_{\text{L,ENDOR}}^{} = - \frac{1}{h}\,\mu_{\text{N}}^{}\,g_{\text{n}}^{}\,B}
#'
...
#'
#' @format A data frame with ... rows and 9 variables/columns:
#' \describe{
...
#'   \item{Abund_Natur_Percent}{Numeric, pointing to natural abundance of an isotope.}

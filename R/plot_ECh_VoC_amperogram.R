...
#'
#' @description
#'   Visualization of voltammogram or chronoamperogram either by \href{https://ggplot2.tidyverse.org/}{ggplot2}
#'   (static plot) or \href{https://plotly.com/r/}{plotly} (interactive one) package. The corresponding
#'   data frame for the plot can be created from the ASCII text file,

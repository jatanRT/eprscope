...
#'   Eyring model.}
#'   \item{plot}{Static ggplot2-based object, showing graphical representation of the (non-)linear fit,
...
#'   the experiment (\eqn{k} \emph{vs} \eqn{T} or \eqn{ln\,(k)\,/\,T} \emph{vs} \eqn{1\,/\,T}) and the "Eyring" should be positive

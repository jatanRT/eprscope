...
#'  while for less polar solvents common quartz tubes (with the i.d. of \eqn{(2-4)\,\text{mm}}) can be applied.
...
#'   \item{Solubility_g100gW}{Character, pointing solubility in water expressed

...
#'
#'
#' @description This function is based on the \code{\link[data.table]{fread}} with the purpose to read
...
#'   to kinetic-like experiments. \strong{Default}: \code{time.series.id = NULL} (see also the \code{data.structure}
#'   argument).

...
#'
#'
#' @param data.spectrum EPR spectrum data frame/table with magnetic flux density (in \code{mT} or \code{G}) column
...
#' @examples
#' \dontrun{
#' Bextreme_Spec(data.spectrum,Blim = c(349.54,359.54),extreme = 'maximum')
...
Bextreme_Spec  <-  function(data.spectrum,
                            B = "B_mT",

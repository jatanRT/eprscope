...
#'   The \eqn{10^{-3}\,/\,10^6} factor is introduced due to the specific \eqn{[a] = \text{mT}} \eqn{\rightarrow}
#'   \eqn{[A] = \text{MHz}} conversion. The latter is suitable for the EPR simulations and/or ENDOR.
#'
#'

...
#'   A short description...
#'   \tabular{lcll}{
#'    \strong{Reaction Scheme} \tab \strong{model.react} \tab \strong{kin.params} \tab \strong{Description} \cr
  #'  \eqn{(x=1)\text{R} \overrightarrow{k_1} \text{B}} \tab "(x=1)R --> [k1] B" \tab \code{k1},\code{qvar0R} \tab Blah \cr
#'   }
#'
#'
#'

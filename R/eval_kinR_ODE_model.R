...
#'   \code{"(a=1)A --> [k1] (r=1)R"} \tab Basic irreversible radical formation \cr
...
#'   reduction or spin trapping (transient radical, \code{A}, is not visible within the common EPR time scale). \cr

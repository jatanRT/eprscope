...
#'   as column.
#' @param B Character/String pointing to magnetic flux density \code{column} (in the original \code{data.spec.integ})
...
#' @param output.vector Logical, whether to "vectorize" the result in order to use it (in a form of additional

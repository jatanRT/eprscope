...
#'    or the above-mentioned \code{\link{plot_EPR_Specs2D_interact}} (see also example).
#'
#'
#' @inheritParams plot_EPR_Specs2D_interact
#' @param p \code{Plotly} object corresponding to previous/actual graph/plot.
#' @param data Data frame object to associate with the layout (optional). If not provided, arguments are evaluated

#
#' Comparison Between Experimental and Simulated EPR Spectrum
#'
#'
...
#'   Therefore, there is also option to offset the EPR simulated spectrum underneath the experimental

...
**Note:** On modern *Windows* systems (10/11), all the pre- and post-installation software packages (*OpenJDK*, *Quarto*, *Pandoc*, *LaTeX/Typst* and *CMake* or *Rtools*) can be easily managed either by [*Winget*](https://winstall.app/) *or by the [Chocolatey](https://chocolatey.org/)* systems.

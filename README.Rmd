...
**Note:** On modern *Windows* systems (10/11), all the pre- and post-installation (*Quarto*, *Pandoc* and *LaTeX/Typst*) software packages can be easily managed either by [*Winget*](https://winstall.app/) *or by the [Chocolatey](https://chocolatey.org/)* systems.

...
Any additional questions, comments, remarks or issues can be addressed through several discussion channels like 📧 e-mail [jantar40\@protonmail.com](mailto:jantar40@protonmail.com){.email} or github ![](https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png){width="16"} issues on github source page. There will be also a specialized [Discord](https://discord.com/) community channel to discuss the `{eprscope}` related topics. If somebody is able and interested in package development, please refer to [contributing guide](./.github/CONTRIBUTING.md).
